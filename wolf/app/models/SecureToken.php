...
final class SecureToken extends Record {
     ...
     */
    public static final function generateToken(string $url) {
        use_helper('Hash');
     ...
     */
    public static final function validateToken(string $token, string $url) {
        use_helper('Hash');
        $hash = new Crypt_Hash('sha256');
        AuthUser::load();
    ...
    private static final function getToken(string $username, string  $url) {
        use_helper('Hash');
        $hash = new Crypt_Hash('sha256');
    ...
    private static final function getTokenTime(string $username, string $url) {
        use_helper('Hash');
        $hash = new Crypt_Hash('sha256');
        $time = 0;
