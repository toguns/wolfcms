...
class Form {
     ...
     */
    public static function input($name, $id = false, $type = 'text', $label = false, $placeholder = false, $required = false, $focus = false, $autocomplete = false, $options = []) {
        $id = ($id !== false) ? $id : $name;
     ...
     * @return string 
     */
    public static function textarea($name, $id = false, $rows = 5, $value = false, $label = false, $placeholder = false, $required = false, $focus = false, $options = []) {
        $id = ($id !== false) ? $id : $name;
     ...
     * @return string 
     */
    public static function radio($name, $values = [], $required = false, $focus = false, $options = []) {
        $ret = '';
        $opt = '';
     ...
     * @return string 
     */
    public static function box($name, $values = [], $required = false, $focus = false, $options = []) {
        $ret = '';
        $opt = '';
     ...
     * @return string 
     */
    public static function dropdown($name, $values = [], $multiple = false, $selected = false, $size = 1, $required = false, $focus = false, $options = []) {
     ...
     * @return string 
     */
    public static function button($name = "Submit", $type = 'submit', $options = []) {
        $opt = '';
