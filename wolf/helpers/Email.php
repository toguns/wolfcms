...
class Email {
    ...
    private $_bcc_array = [];
    private $_headers = [];
    private $_attach_name = [];
    private $_attach_type = [];
    private $_attach_disp = [];
    private $_protocols = ['mail', 'sendmail', 'smtp'];
    private $_base_charsets = ['iso-8859-1', 'us-ascii'];
    private $_bit_depths = ['7bit', '8bit'];
    ...
    function _unwrapSpecials() {
        $this->_finalbody = preg_replace_callback("/\{unwrap\}(.*?)\{\/unwrap\}/si", [$this, '_removeNlCallback'], $this->_finalbody);
    }
