...
foreach ($paths as $i => $path) {
    if ($i + 1 == $nb_path) {
        ...
        $progres_path .= $path . '/';
        $out .= '<a href="' . getUrl('plugin/file_manager/browse/' . rtrim($progres_path, '/')) . '">' . htmlContextCleaner($path) . '</a>/';
    }
}
?>
<h1><a href="<?php echo getUrl('plugin/file_manager'); ?>">public</a>/<?php echo $out; ?></h1>
        ...
        <?php foreach ($files as $file): ?>
            <tr class="<?php echo odd_even(); ?>">
                ...
                <td>
                    ...
                    <a href="<?php echo getUrl('plugin/file_manager/delete/' . $dir . $file->name . '?csrf_token=' . SecureToken::generateToken(BASE_URL . 'plugin/file_manager/delete/' . $dir . $file->name)); ?>" onclick="return confirm('<?php echo __('Are you sure you wish to delete?'); ?> <?php echo $file->name; ?>?');"><img src="<?php echo ICONS_PATH; ?>action-delete-16.png" alt="<?php echo __('delete file icon'); ?>" title="<?php echo __('Delete file'); ?>" /></a>
                </td>
            </tr>
        <?php endforeach; ?>
    </tbody>
...
<div id="popups">
    ...
    <div class="popup" id="chmod-popup" style="display:none;">
        ...
        <form action="<?php echo getUrl('plugin/file_manager/chmod'); ?>" method="post">
            <div>
    ...
    <div class="popup" id="rename-popup" style="display:none;">
        ...
        <form action="<?php echo getUrl('plugin/file_manager/rename'); ?>" method="post">
            <div>
...
<div id="boxes">
    ...
    <div id="create-file-popup" class="window">
        ...
        <div class="content">
            <form action="<?php echo getUrl('plugin/file_manager/create_file'); ?>" method="post">
    ...
    <div id="create-directory-popup" class="window">
        ...
        <div class="content">
            <form action="<?php echo getUrl('plugin/file_manager/create_directory'); ?>" method="post">
    ...
    <div id="upload-file-popup" class="window">
        ...
        <div class="content">
            <form action="<?php echo getUrl('plugin/file_manager/upload'); ?>" method="post" enctype="multipart/form-data">
