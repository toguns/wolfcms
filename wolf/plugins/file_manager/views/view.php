...
<?php } else { ?>
    <form method="post" action="<?php echo getUrl('plugin/file_manager/save'); ?>">
        <div class="form-area">
            <p class="content">
        ...
        <p class="buttons">
            ...
            <?php echo __('or'); ?> <a href="<?php echo getUrl('plugin/file_manager/browse/' . $progres_path); ?>"><?php echo __('Cancel'); ?></a>
        </p>
    </form>
<?php } ?>
