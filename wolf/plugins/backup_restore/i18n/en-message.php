 ...
 */
return [
    'Are you sure you wish to restore?' => 'Are you sure you wish to restore?',
    ...
    'What style of timestamp should be encorporated into the filename.' => 'What style of timestamp should be encorporated into the filename.',
