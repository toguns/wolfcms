...
define('CORE_ROOT', __DIR__ . DS . 'wolf');
...
if (!defined('DEBUG')) {
    echo 'Please install Wolf CMS first, thank you.';
    exit();
}
...
<html>
    ...
    <body>
        ...
        <div id="content">
            ...
            <?php
            if (count($fatals) > 0) {
                echo '<p>One or more FATAL level potential security issues have been detected. You are strongly advised to correct them!</p>';
            }
            ?>
